...
>
  <Typography
    ...
    sx={{
      ...
      color: '#FFD700', // gold for strong visual contrast
      letterSpacing: 2,
    }}
  >
    ...
    >
        ...
        >
            ...
            <Typography 
                ...
                sx={{
                        fontWeight: 'bold', color: saveModalMessage.includes('✅') ? 'success.main' : 'error.main', 
                }}
            >
                {saveModalMessage}
            </Typography>
  ...
  >
    <Typography
      ...
      sx={{
        ...
        textTransform: 'uppercase',
        letterSpacing: 2,
        color: '#FFD700', // gold headings for contrast
      }}
    >
      {role} Teams
    </Typography>
...
>
  ...
  .sort((a, b) => a.ranking - b.ranking)   // ✅ sort ascending by ranking
  .map(team => {
